...
<html prefix="og: http://ogp.me/ns#" lang="en-GB" dir="ltr">
	<head>
		<title>News and offer of the Week - IMAGLOBECREATIVE</title>
		<meta charset="utf-8" />
		...
		<meta property="og:url" content="http://imaglobecreative.com/news-and-offer-of-the-week.php" />
		<meta property="og:title" content="News and offer of the Week" />
		...
		<link rel="stylesheet" type="text/css" href="pcss/news-and-offer-of-the-week.css?14-0-6-1-637918464345561710" media="screen,print" />
		...
		<script type="text/javascript">
			...
			x5engine.utils.currentPagePath = 'news-and-offer-of-the-week.php';
			x5engine.boot.push(function () { x5engine.imPageToTop.initializeButton({}); });
		</script>
		<meta name="apple-itunes-app" content="app-id=665879631, app-argument=http://imaglobecreative.com/x5feedready.xml">
		<link rel="icon" href="favicon.png?14-0-6-1-637918464345436547" type="image/png" />
	...
	<body>
		<div id="imPageExtContainer">
			<div id="imPageIntContainer">
				...
				<div id="imPage">
					<div id="imHeader">
						<h1 class="imHidden">News and offer of the Week - IMAGLOBECREATIVE</h1>
...
$(function () {$('#imStickyBar_imMenuObject_01 ul li').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_01-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_01-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
				...
				<div id="imCell_1" class="" > <div id="imCellStyleGraphics_1"></div><div id="imCellStyle_1"  data-responsive-sequence-number="1"><!-- search-tag dynObj_9_01 start -->
				<div id="dynObj_9_01">
				<?php
					$dynObj = Configuration::getDynamicObject('dynObj_9_01');
					$pa = Configuration::getPrivateArea();
					$user = $pa->whoIsLogged();
					if ($user !== false && (in_array($user['uid'], array()) || in_array_field($user['groups'], array()) || in_array($user['uid'], $imSettings['access']['admins']))) {
						if (isset($_POST['ObjectId']) && isset($_POST['PageId']) && $_POST['ObjectId'] == '1' && $_POST['PageId'] == '9') {
					...
					<div class="dynamic-object-text dynamicText" style="display: none;">
						<form action="<?php echo basename($_SERVER['PHP_SELF']) ?>" method="post">
							...
							<div style="text-align: center;" class="wysiwyg-buttons">
								...
								<input type="button" value="Cancel" onclick="window.top.location.reload()">
							</div>
						</form>
						<script>
							x5engine.boot.push(function () { x5engine.cms.initialize('#dynObj_9_01', { autoGrow: false, css: ['style/style.css', 'pcss/news-and-offer-of-the-week.css'], imageuploadurl: 'res/imageupload.php', availableFonts: ['Abel','Arial','Arial Black','Book Antiqua','Comic Sans MS','Courier New','Georgia','Helvetica','Impact','Lucida Console','Lucida Grande','Lucida Sans Unicode','Palatino Linotype','Tahoma','Times New Roman','Trebuchet MS','Verdana'], defaultFontSize: 14, defaultFontFamily: 'Abel'}); });
						</script>
					</div>
				<?php } else { echo $dynObj->getContent(); } ?>
				</div>
				<!-- search-tag dynObj_9_01 end -->
				</div></div></div>
				</div>
